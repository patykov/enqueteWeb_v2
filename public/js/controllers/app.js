angular.module('enqueteweb').controller('appCtrl', function($scope, $http, $location,cadastroDeUsuarios,cadastroDeEnquetes) {
	//app
	$scope.newUser = {};	
	$scope.logingUser = {};
	...
	$scope.registraEnquete = function(){
		if($scope.novaEnquete.ordem == undefined){
			$scope.novaEnquete.ordem = false;
		}
		if($scope.novaEnquete.imagem == undefined){
			$scope.novaEnquete.imagem = "";
		}

		$scope.novaEnquete.estado = "inativa";
